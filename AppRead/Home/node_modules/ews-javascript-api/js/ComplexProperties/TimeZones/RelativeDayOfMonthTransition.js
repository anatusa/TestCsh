...
var RelativeDayOfMonthTransition = (function (_super) {
    ...
    RelativeDayOfMonthTransition.prototype.CreateTransitionTime = function () {
        return TimeZoneInfo_1.TimeZoneInfo.TransitionTime.CreateFloatingDateRule(new DateTime_1.DateTime(this.TimeOffset.Milliseconds), this.Month, this.WeekIndex == -1 ? 5 : this.WeekIndex, EwsUtilities_1.EwsUtilities.EwsToSystemDayOfWeek(this.DayOfTheWeek));
    };
    /**
